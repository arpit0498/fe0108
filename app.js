...
// Iteration 1: Use the correct conditional statement for calculating loss
function calculateProfitLoss(initial, quantity, current) {
  if (initial > current) {
    ...
    // Iteration 2: Use the conditional statement for calculating profit if above code doesn't satisfy the condition
